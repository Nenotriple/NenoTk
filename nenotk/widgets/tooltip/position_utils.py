...
def resolve_tooltip_anchor_offsets(tip: 'ToolTip') -> tuple[int, int, int, int]:
...
def calculate_tooltip_position(tip: 'ToolTip', event: Event) -> tuple[int, int]:
...
def adjust_position_for_screen_bounds(tip: 'ToolTip', x: int, y: int, mouse_x: int, mouse_y: int, origin: str) -> tuple[int, int]:
...
def _estimate_tip_size(tip: 'ToolTip') -> tuple[int, int]:
