...
#region Class Setup
    ...
    def __init__(
        ...
        *,
        text: Union[str, list[str], Callable[[], Union[str, list[str]]]] = "",
        state: Literal["normal", "disabled"] = ToolTip.STATE,
        bg: str = ToolTip.BG,
        fg: str = ToolTip.FG,
        font: Optional[Tuple[str, int, str]] = ToolTip.FONT,
        borderwidth: int = ToolTip.BORDERWIDTH,
        opacity: float = ToolTip.OPACITY,
        relief: str = ToolTip.RELIEF,
        justify: str = ToolTip.JUSTIFY,
        wraplength: int = ToolTip.WRAPLENGTH,
        padx: int = ToolTip.PADX,
        pady: int = ToolTip.PADY,
        ipadx: int = ToolTip.IPADX,
        ipady: int = ToolTip.IPADY,
        origin: str = ToolTip.ORIGIN,
        widget_anchor: str = ToolTip.WIDGET_ANCHOR,
        tooltip_anchor: str = ToolTip.TOOLTIP_ANCHOR,
        follow_mouse: bool = ToolTip.FOLLOW_MOUSE,
        show_delay: int = ToolTip.SHOW_DELAY,
        hide_delay: int = ToolTip.HIDE_DELAY,
        animation: str = ToolTip.ANIMATION,
        anim_in: int = ToolTip.ANIM_IN,
        anim_out: int = ToolTip.ANIM_OUT
    ) -> None: ...
