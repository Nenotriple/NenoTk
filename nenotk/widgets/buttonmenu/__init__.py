"""
Custom ttk.Button subclass with attached Tkinter Menu shown on button click.

Supported menu positions: `"up"`, `"down"`, `"left"`, `"right"` (relative to button).

Public API:
- ButtonMenu.menu: access the attached tk.Menu for adding menu items.
- ButtonMenu.hide_menu(): hide the menu if displayed.
"""
