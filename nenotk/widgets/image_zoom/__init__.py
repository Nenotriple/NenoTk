...
- Class: `ImageZoomWidget(master, on_render_done=None, **kwargs)`
    ...
    - Methods:
        ...
        - set_image(pil_image: PIL.Image, keep_view: bool = False) -> None
...
- Class: `SplitImage(master=None)`
    ...
    - Methods:
        - load_image(side: str, path: str) -> None
        - fit_both() -> None
        - unload_both() -> None
...
## Example
 ...
 from nenotk import ImageZoomWidget

 root = tk.Tk()
 widget = ImageZoomWidget(root)
 widget.pack(fill="both", expand=True)
 widget.load_image("example.png")
 root.mainloop()
 ```
"""
#region Imports
